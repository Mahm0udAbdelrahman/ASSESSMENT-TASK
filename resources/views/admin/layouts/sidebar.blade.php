            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <!-- Start::slide -->
                        <li class="slide has-sub {{ request()->segment(2) == 'category' ? 'active' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="{{ route('category.index') }}" class="side-menu__item">{{ __('category List') }}</a>
                                </li>

                                <li class="slide">
                                    <a href="{{ route('category.create') }}" class="side-menu__item">{{ __('category Create') }}</a>
                                </li>
                        ...
                        <!-- End::slide -->
                        <!-- Start::slide -->
                        <li class="slide has-sub {{ request()->segment(2) == 'task' ? 'active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <span class="shape1"></span>
                                <span class="shape2"></span>
                                <i class="ti-wallet side-menu__icon"></i>
                                <span class="side-menu__label">{{ __('Taks') }}</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">

                                 <li class="slide">
                                    <a href="{{ route('task.index') }}" class="side-menu__item">{{ __('Task') }}</a>
                                </li>

                                 <li class="slide">
                                    <a href="{{ route('task.create') }}" class="side-menu__item">{{ __('Task Create') }}</a>
                                </li>
